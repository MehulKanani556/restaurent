          ...
          <div style={{ padding: "20px" }}>
            ...
            <div className="d-flex justify-content-between">
              <div className="d-flex align-items-center">
                <div className="me-2 ">
                  <div class="m_group ">
                    <svg viewBox="0 0 24 24" aria-hidden="true" class="m_icon">
                      <g>
              ...
              <tbody className="text-white b_btnn ">
                {currentUsers.map((user) => (
                  <tr key={user.id} className="b_row">
                    ...
                    <td className="b_text_w">{getRoleName(user.role_id)}</td>
          ...
          >
            ...
            <Modal.Body>
              <div className="text-center">
                ...
                <p className="opacity-75">Han sido modificados exitosamente</p>
              </div>
            </Modal.Body>
          </Modal>
